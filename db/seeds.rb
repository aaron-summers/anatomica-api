...
Question.create([
    {content: "What is the study of the body's structure and how its components are assembled called?", category_id: 1, answer: "Anatomy"},
    {content: "The brain is a part of which bodily system?", category_id: 1, answer: "Nervous System"},
    {content: "How many nucleotides in the DNA?", category_id: 1, answer: "Four"},
    {content: "Who discovered Penicillin?", category_id: 1, answer: "Alexander Fleming"}
])
